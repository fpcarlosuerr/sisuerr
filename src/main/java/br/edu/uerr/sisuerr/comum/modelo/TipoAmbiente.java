...
@Dependent
@Entity
@Table(name = "tipo_ambiente", schema = "scsiscomum")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "TipoAmbiente.findByNome", query = "SELECT t FROM TipoAmbiente t WHERE t.nome = :nome")})
public class TipoAmbiente implements Serializable {
    ...
    @Column(name = "nome")
    private String nome;
    @OneToMany(mappedBy = "idTipoAmbiente")
    ...
    public String toString() {
        return "br.edu.uerr.sisuerr.comum.modelo.TipoAmbiente[ id=" + id + " ]";
    }
